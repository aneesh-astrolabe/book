...
import com.astrolabe.logbook.common.constant.ErrorCodes;
...
public class ProfileServiceImpl implements ProfileService {
	...
	public <T>ServiceResponse<T> getUserProfile(UserProfileRequestVO userProfileRequest) throws ServiceException {
		...
		if(userName != null && userName.equalsIgnoreCase("admin") 
			...
			return (ServiceResponse<T>) responseBuilder
					.buildError(new ServiceException(ErrorCodes.NON_ADMIN_ERR_CODE, ErrorCodes.NON_ADMIN_ERR_MSG));
		}
